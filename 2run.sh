...
export OLLAMA_HOST="ollama.c1.ai-dev.numerique-interieur.com"
...
${pythonVersion} -m streamlit run 2app.py --browser.gatherUsageStats false $([ ! -z "${serverAddress}" ] && echo --server.address ${serverAddress}) $([ ! -z "${portNumber}" ] && echo --server.port ${portNumber})
