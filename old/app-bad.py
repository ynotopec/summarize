...
os.environ['OPENAI_API_BASE']="http://10.0.1.1:11434/v1"
...
#batch_size=1,temperature=0.1)
    #llm = ChatLiteLLM(temperature=0.2,model="ollama/vicuna:13b-16k", api_base="http://127.0.0.1:11434")
    #os.environ["OPENAI_API_BASE"]="http://10.0.1.1:11434/v1"
    #llm = ChatOpenAI(temperature=0.2,model_name="vicuna:13b-16k")
    llm = ChatOpenAI(temperature=0.2,model_name="vicuna:13b-16k",api_openai_base="http://10.0.1.1:11434/v1",api_openai_key="EMPTY")
    #llm = ChatOpenAI(model_name="mixtral",api_openai_base="https://api-mixtral.c1.ai-dev.numerique-interieur.com/v1",api_openai_key="EMPTY")

    #llm = ChatLiteLLM(temperature=0.2,model="ollama/gemma", api_base="http://127.0.0.1:11434")
#os.environ["OLLAMA_SERVER_URL"])
...
#chat = ChatLiteLLM(temperature=0,model="ollama/vicuna:13b-16k", api_base="http://127.0.0.1:11434")
#os.environ["OPENAI_API_BASE"]="http://10.0.1.1:11434/v1"
#chat = ChatOpenAI(temperature=0,model_name="vicuna:13b-16k")
chat = ChatOpenAI(temperature=0.2,model_name="vicuna:13b-16k",api_openai_base="http://10.0.1.1:11434/v1",api_openai_key="EMPTY")

#chat = ChatLiteLLM(temperature=0,model="ollama/gemma", api_base="http://127.0.0.1:11434")
#os.environ["OLLAMA_SERVER_URL"])
...
if url:
    with st.spinner('Processing...'):
        ...
        text_input="<context>\n" + summary_english + "<context>\nWrite clearly, concisely and beautifully" + summary_english
